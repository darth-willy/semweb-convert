...
import wvw.semweb.convert.nools.NoolsUtils;

public class Construct2NoolsVisitor extends Construct2Visitor {
	...
	public Construct2NoolsVisitor(Construct2 converter) {
		super(converter);
	}
	...
	private void processFilters() {
		Construct2NoolsFilterVisitor filterVisit = new Construct2NoolsFilterVisitor(varMap);
